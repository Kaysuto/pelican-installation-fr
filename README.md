...
![alt text](https://i.imgur.com/HlrXfU2.png)
  
6. Configurez votre domaine pour qu'il pointe vers le tunnel Cloudflare (`Public hostname`) :
...
7. **Assurez-vous que votre serveur web est configuré pour accepter les connexions SSL de Cloudflare.** 👉 [Configuration SSL](https://github.com/Kaysuto/pelican-installation-fr/blob/main/README.md#-configuration-du-serveur-web)
